            ...
            children: <Widget>[
              Container( 
                child:Center(child: IconButton(
                  ...
                  icon: Icon(Icons.menu,color: (currentNav==0)?Colors.greenAccent[400]:Colors.white),
                  onPressed: ()=>setState(()=>currentNav=0),
                )),
                decoration: BoxDecoration(
                  color: (currentNav==0)?Colors.white:Colors.greenAccent[400],
              ...
              Container( 
                child:Center(child: IconButton(
                  iconSize: 30,
                  alignment: Alignment.center,
                  icon: Icon(Icons.home,color: (currentNav==1)?Colors.greenAccent[400]:Colors.white),
                  onPressed: ()=>setState(()=>currentNav=1),
                )),
                decoration: BoxDecoration(
                  color: (currentNav==1)?Colors.white:Colors.greenAccent[400],
                  borderRadius: BorderRadius.circular(10)
                ),
              ),
              Container( 
                child:Center(child: IconButton(
                  iconSize: 30,
                  alignment: Alignment.center,
                  icon: Icon(Icons.calendar_today,color: (currentNav==2)?Colors.greenAccent[400]:Colors.white),
                  onPressed: ()=>setState(()=>currentNav=2),
                )),
                decoration: BoxDecoration(
                  color: (currentNav==2)?Colors.white:Colors.greenAccent[400],
                  borderRadius: BorderRadius.circular(10)
                ),
              ),
